...
public class STTService {
	...
	/*
	 * public String jsonToString(String jsonStr){ String resultText = ""; try {
	 * JSONObject jsonObj = new JSONObject(jsonStr); resultText =
	 * (String)jsonObj.get("text"); } catch (Exception e) { // TODO Auto-generated
	 * catch block e.printStackTrace(); } return resultText; }
	 */
