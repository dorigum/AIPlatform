...
public class ObjectDetectionService {
	...
	public ArrayList<ObjectVO> jsonToVOList(String jsonStr) {
		...
		try {
			...
			JSONObject predict0 = (JSONObject) predictArray.get(0);

			JSONArray namesArray = (JSONArray) predict0.get("detection_names");
			JSONArray boxArray = (JSONArray) predict0.get("detection_boxes");
